...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across NCSC-NL guidance documents. Covers ICT-beveiligingsrichtlijnen, BIO, factsheets, and technical publications.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'patch management', 'network security')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific NCSC-NL guidance document by reference (e.g., 'NCSC-NL-ICT-2023', 'NCSC-NL-BIO-2023').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "NCSC-NL document reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search NCSC-NL security advisories and vulnerability notifications. Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'ransomware', 'zero-day')" },
        severity: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific NCSC-NL security advisory by reference (e.g., 'NCSC-NL-ADV-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "NCSC-NL advisory reference" },
      },
      required: ["reference"],
    },
  },
      ...
      switch (name) {
        ...
        case "nl_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "NCSC-NL (Nationaal Cyber Security Centrum) MCP server. Provides access to NCSC-NL guidance including ICT-beveiligingsrichtlijnen, BIO, and security advisories.",
